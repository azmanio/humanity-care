 ...
 * Slug: charity-blocks/blog-right-sidebar
 * Categories: charity-blocks, blog-right-sidebar
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','charity-blocks'); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"charity-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->