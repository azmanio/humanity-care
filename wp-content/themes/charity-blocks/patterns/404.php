...
<div class="wp-block-buttons" style="margin-top:60px"><!-- wp:button {"gradient":"ternary-to-primary","style":{"border":{"radius":"30px"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-ternary-to-primary-gradient-background has-background wp-element-button" href="/" style="border-radius:30px"><?php esc_html_e('Return Home','charity-blocks'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->